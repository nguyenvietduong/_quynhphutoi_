  ...
  return (
    <div className="qp-acc-page">
      <div className="qp-admin-toolbar">
        ...
        {canEdit && <Link href="/admin/di-tich/them" className="qp-btn-primary">+ Thêm di tích</Link>}
      </div>
              ...
              {pg.paged.map((r) => (
                <tr key={r.slug}>
                  ...
                  <td className="qp-admin-actions">
                    <RowActions actions={[
                      { value: "edit", label: "Sửa", hidden: !canEdit, run: () => router.push(`/admin/di-tich/${r.slug}/sua`) },

  ...
  return (
    <form className="form-panel" onSubmit={handleSubmit} noValidate>
      ...
      <div className="social-row">
        <button type="button" className="btn-social" onClick={() => toast.success("Tính năng đăng ký bằng Google sẽ sớm có.")}>
        ...
        <button type="button" className="btn-social" onClick={() => toast.success("Tính năng đăng ký bằng GitHub sẽ sớm có.")}>
